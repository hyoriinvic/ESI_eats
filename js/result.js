...
var result = {
    ...
    "INFP" : {
        ...
        "shleyz-type" : "과대망상 람찌",
        "mbti-type" : "INFP",
        "mbti-explain" : "<b>#이상적 #잔다르크 #외유내강</b><br>다채로운 상상과 걱정이 넘쳐나는 람찌! 이 때문인지 주위의 시선을 많이 의식해 만나기 전에도, 만날 때도 항상 신경쓰이는 게 너무 많아요. 하지만 최악에서도 긍정적인 면을 바라본다는 것은 숨겨진 장점! 지금 람찌는 무슨 상상을 하고 있을까요?",
        "result-image" : "IN.png", // 각 유형별 이미지
